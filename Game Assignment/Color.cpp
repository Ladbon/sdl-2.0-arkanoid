...
void Color::randomize() {
	this->red   = Utils::Random::random(0, 255);
	this->green = Utils::Random::random(0, 255);
	this->blue  = Utils::Random::random(0, 255);
}

void Color::randomizeAlpha() {
	this->alpha = Utils::Random::random(0, 255);
}

void Color::setColor(int color_mask) {
	red	  = (color_mask >> 16) & 0xFF;
	green = (color_mask >>  8) & 0xFF;
	blue  =  color_mask        & 0xFF;
}

SDL_Color Color::getAsSDL() {
